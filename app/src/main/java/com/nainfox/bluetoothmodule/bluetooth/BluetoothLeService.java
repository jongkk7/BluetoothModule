...
public class BluetoothLeService extends Service {
    ...
    public static final UUID UUID_FBL770_INIT_SETTING;
    public static final UUID UUID_FBL770_PIOREAD_NOTIFY;
    public static final UUID UUID_FBL770_SPP_NOTIFY = UUID.fromString(SampleGattAttributes.FBL770_SPP_NOTIFY);
    public static final UUID UUID_FBL770_SPP_WRITE;

    static
    {
        UUID_FBL770_PIOREAD_NOTIFY = UUID.fromString(SampleGattAttributes.FBL770_PIOREAD_NOTIFY);
        UUID_FBL770_ADC0_NOTIFY = UUID.fromString(SampleGattAttributes.FBL770_ADC0_NOTIFY);
        UUID_FBL770_ADC1_NOTIFY = UUID.fromString(SampleGattAttributes.FBL770_ADC1_NOTIFY);
        UUID_FBL770_INIT_SETTING = UUID.fromString(SampleGattAttributes.FBL770_INIT_SETTING);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            //Log.d(TAG, "boradcastUpdate : " + new String(data));
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if (UUID_FBL770_PIOREAD_NOTIFY.equals(characteristic.getUuid()))
        {
            ...
            localBluetoothGattDescriptor = characteristic.getDescriptor(UUID.fromString(SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic paramBluetoothGattCharacteristic, byte paramByte)
    {
        ...
        paramBluetoothGattCharacteristic.setValue(new byte[] { paramByte });
        boolean bool = this.mBluetoothGatt.writeCharacteristic(paramBluetoothGattCharacteristic);
        Log.d(TAG, "writeCharacteristic : " + bool);
    }

    public void writeCharacteristics(BluetoothGattCharacteristic paramBluetoothGattCharacteristic, String paramString)
    {
        if ((this.mBluetoothAdapter == null) || (this.mBluetoothGatt == null))
        {
            Log.w(TAG, "BluetoothAdapter not initialized");
